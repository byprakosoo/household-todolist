...
import { BarChart3, CalendarDays, Settings, ShoppingCart } from "lucide-react";
import { cn } from "@/lib/utils";

const NAV_ITEMS = [
  { href: "/board", label: "Board", icon: CalendarDays },
  { href: "/buying", label: "Buying", icon: ShoppingCart },
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-col items-center justify-center gap-1 px-3 py-2 text-[11px] font-medium transition-all rounded-xl",
                isActive
                  ? "text-primary"
